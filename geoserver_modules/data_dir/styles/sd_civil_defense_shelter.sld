      ...
      <sld:FeatureTypeStyle>
        <sld:Rule>
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:ExternalGraphic>
                <sld:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="sd_civil_defense_shelter.svg"/>
          ...
          <sld:TextSymbolizer>
            ...
            <sld:Fill>
              <sld:CssParameter name="fill">#795548</sld:CssParameter>
            </sld:Fill>
          </sld:TextSymbolizer>
          <sld:TextSymbolizer>
            <sld:Label>
