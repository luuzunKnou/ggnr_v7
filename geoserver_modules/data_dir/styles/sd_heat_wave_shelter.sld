      ...
      <sld:FeatureTypeStyle>
        <sld:Rule>
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:ExternalGraphic>
                <sld:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="sd_heat_wave_shelter.svg"/>
          ...
          <sld:TextSymbolizer>
            <sld:Label>
              <ogc:PropertyName>rstr_nm</ogc:PropertyName>
            </sld:Label>
            <sld:Font>
