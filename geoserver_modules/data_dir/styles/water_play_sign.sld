      ...
      <sld:FeatureTypeStyle>
        <sld:Rule>
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:ExternalGraphic>
                <sld:OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://127.0.0.1:8090/geoserver/www/symbol/safety/water_play_sign.svg"/>
          ...
          <sld:TextSymbolizer>
            ...
            <sld:Fill>
              <sld:CssParameter name="fill">#0369A1</sld:CssParameter>
            </sld:Fill>
          </sld:TextSymbolizer>
          <sld:TextSymbolizer>
            <sld:Label>
