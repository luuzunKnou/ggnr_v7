		    ...
		    if (this.readyState == 4) {
		        ...
		        var appendStr = " ";
 				for(var i=0; i<totalCount; i++){ 
 					...
 					appendStr += '		<td colspan="3" class="prposAreaDstrcCodeNm">'+result.landUses.field[i].prposAreaDstrcCodeNm+'</td>'
 					appendStr += '	</tr>'
 					appendStr += '	<tr>'
 					appendStr += '		<th>저촉여부</th>'
 					appendStr += '		<td class="cnflcAtNm">'+result.landUses.field[i].cnflcAtNm+'</td>'
 					appendStr += '		<th>등록일자</th>'
 					appendStr += '		<td class="registDt">'+result.landUses.field[i].registDt+'</td>'
 					appendStr += '	</tr>'
 					appendStr += '</table>'			
 				}
