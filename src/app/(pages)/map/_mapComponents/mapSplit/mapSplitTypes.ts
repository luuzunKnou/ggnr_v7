...
/** 분할선 컨트롤 pill 위치 (0~1, 양끝 여백) */
export const MAP_SPLIT_CONTROL_OFFSET_MIN = 0.08;
export const MAP_SPLIT_CONTROL_OFFSET_MAX = 0.92;
...
/** pill 반폭(접힘) */
export const MAP_SPLIT_CONTROL_PILL_HALF_PX = 28;
/** pill 반폭(펼침, 버튼 3~4개) — 우측 clamp */
export const MAP_SPLIT_CONTROL_PILL_HALF_EXPANDED_PX = 58;
/** pill 전폭(펼침) — 좌측 앵커 시 우측 확장 여유 */
