                ...
                return (
                  ...
                  >
                    <td className="px-2 py-1.5">
                      <span className="inline-block max-w-full truncate rounded-full bg-slate-100 px-1.5 py-0.5 text-[11px] font-semibold text-slate-700">
                        {l.roadType || '—'}
                      </span>
                    </td>
                    <td className="truncate px-2 py-1.5 text-slate-800" title={l.routeName || undefined}>
                      {l.routeName || '(노선명 미입력)'}
                    </td>
                  </tr>
                );
