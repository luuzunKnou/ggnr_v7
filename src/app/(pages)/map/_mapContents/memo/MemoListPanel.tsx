    ...
    <div className="flex h-full min-h-0 flex-col bg-white">
      ...
      <div className="shrink-0 space-y-2 border-b border-slate-100 px-3 py-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-8 w-full rounded border border-slate-200 pl-7 pr-2 text-xs"
          />
        </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-2 py-2">
        ...
        {!loading && !error && items.length === 0 && (
          <p className="py-6 text-center text-xs text-slate-400">등록된 메모가 없습니다.</p>
        )}
        {!loading &&
          items.map((row) => {
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 line-clamp-2 text-[10px] text-slate-500">{row.contents || "—"}</p>
