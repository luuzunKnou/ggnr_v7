      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12 grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
            ...
            <Link
              href="/map"
              className="relative overflow-hidden bg-blue-600 p-8 text-white min-h-[280px] flex flex-col items-center justify-center text-center hover:bg-blue-700 transition-colors cursor-pointer block"
            >
