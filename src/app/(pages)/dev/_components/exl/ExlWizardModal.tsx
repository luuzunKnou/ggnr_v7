        ...
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
          ...
          {step === 1 && (
            <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-hidden">
              ...
              <div className="shrink-0 rounded-md border border-gray-200 bg-muted/30 p-3 space-y-3">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-xs text-muted-foreground">
                    그룹명을 비우면 조회는 «기타», 지도에서는 «미분류»로 표시됩니다.
                  </span>
                </div>
              ...
              <div
                className={cn(
                  'shrink-0 rounded-md p-3 space-y-2',
              ...
              <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-hidden rounded-md border border-gray-200 bg-muted/30 p-3">
                ...
                <div
                  className="min-h-0 overflow-hidden rounded-md border border-border/60 bg-background/40"
                  role="radiogroup"
                    ...
                    {EXCEL_UPLOAD_WORKFLOW_OPTIONS.map((opt) => {
                      ...
                      return (
                        <li key={opt.id}>
                          <label
                            className={cn(
                              'flex cursor-pointer gap-3 px-3 py-2 text-left transition-colors',
          ...
          {step === 4 && (
            <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden">
              ...
              <div
                ...
                className="min-h-0 flex-1 overflow-auto rounded-md border border-gray-200 bg-muted/30 p-3 shadow-xs"
              >
